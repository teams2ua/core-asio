#include "../include/RequestResponce.hpp"
...
void RequestResponse::execute() {
    ...
    resolver_.async_resolve(
        ...
        "http",
        [this](const asio::error_code& err, const tcp::resolver::results_type& endpoints) {
    ...
    const tcp::resolver::results_type& endpoints)
{
    if (!err)
    {
        ...
        asio::async_connect(socket_, endpoints,
            [this](const asio::error_code& err, const tcp::endpoint& endpoint) 
        {
            handle_connect(err); 
        });
    }
